...
public class ReplayController implements Initializable {
    ...
    private static final String WHITE_TEXT = "-fx-border-color: white;";
    private static final String BLACK_TEXT = "-fx-border-color: black;";
    ...
    private void refreshLabels() {
        listOfNameLabels.forEach(label -> label.styleProperty().setValue(label.getStyle() + "-fx-text-fill: white;"));
